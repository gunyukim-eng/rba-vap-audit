...
const MANUAL_SECTIONS=[
  ...
  {n:'05',img:'manual/qcard.png',
   ko:{title:'문항에 답하기 — 예/아니오 + 근거 기록',desc:'항목을 열면 <b>경영진 면담 → 기록 검토 → 근로자 면담</b> 3단계로 진행합니다. 각 문항에 <b>예 / 아니오 / N/A</b>를 누르면, 아래에 <b>📝 메모</b>와 <b>📷 사진</b> 버튼이 나타납니다. 위반이면 근거를 반드시 남기세요.',steps:['문항 아래 회색 글씨는 <b>판정 기준</b>입니다(임계값·등급·N/A 조건). 누르기 전에 확인하세요.','<b>📝 메모</b> — 위반 내용, 확인한 서류명, 관찰 사항을 적습니다. 이 내용이 Excel과 AI 정리에 반영됩니다.','<b>📷 사진</b> — 급여명세서·계약서·현장 사진 등 증거를 첨부합니다.','답하면 카드 색이 바뀌고(초록/빨강) 상단 등급이 자동 재계산됩니다.','하단 <b>다음</b>으로 단계를 이동합니다.']},
   en:{title:'Answer a Question — Yes/No + Evidence',desc:'Opening an item runs three steps: <b>Management interview → Document review → Worker interview</b>. Tap <b>Yes / No / N/A</b> on each question and the <b>📝 Note</b> and <b>📷 Photo</b> buttons appear below. Always record evidence for a violation.',steps:['The grey text under each question is the <b>judging criteria</b> (thresholds, grade, N/A conditions). Read it before answering.','<b>📝 Note</b> — record the violation, the document you checked, and what you observed. This flows into Excel and the AI summary.','<b>📷 Photo</b> — attach evidence such as payslips, contracts, or site photos.','Answering recolors the card (green/red) and recalculates the grade above.','Use <b>Next</b> at the bottom to move between steps.']}},
  ...
  {n:'08',img:'manual/summary.png',
   ko:{title:'점검 마무리 — AI 발견사항 정리',desc:'항목 점검을 마친 뒤 <b>📝 AI 발견사항 정리</b>를 누르면, 그 항목의 위반 문항·메모·AI 판정 근거를 종합해 보고서용 <b>Findings</b>와 <b>Reference</b> 문장으로 정리해 줍니다. 홈 화면 상단의 <b>📝 AI 발견사항 전체 요약</b>은 점검한 모든 항목을 한 번에 정리합니다.',steps:['정리된 문장은 그대로 Excel 내보내기에 반영됩니다.','<b>다시 생성</b>으로 재작성, <b>삭제</b>로 지울 수 있습니다.','메모를 자세히 적어둘수록 정리 품질이 좋아집니다.','AI 초안이므로 감사자가 검토·확정하세요.']},
   en:{title:'Wrap Up — AI Findings Summary',desc:'After assessing an item, tap <b>📝 AI Findings Summary</b> to combine its violated questions, your notes, and the AI rationale into report-ready <b>Findings</b> and <b>Reference</b> text. On the home screen, <b>📝 Summarize All Findings</b> does this for every assessed item at once.',steps:['The summary text flows straight into the Excel export.','Use <b>Regenerate</b> to rewrite it or <b>Delete</b> to remove it.','The more detail you put in your notes, the better the summary.','It is an AI draft — the auditor reviews and finalizes.']}},
  {n:'09',img:'manual/excel.png',
  ...
  {n:'10',img:'manual/fab.png',
   ko:{title:'그 밖의 질문 — AI 도우미',desc:'특정 항목과 무관한 <b>전반적인 질문</b>은 어느 화면에서든 우측 하단 <b>✦</b> 버튼으로 AI 도우미를 열어 물어보세요.',steps:['문서 사진을 첨부하면 OCR로 읽어 분석합니다.','질문을 입력하면 심사 기준에 근거해 답변합니다.','특정 항목에 대한 질문은 그 항목 화면의 <b>🤖 AI 자동판정</b>에서 물어야 더 정확합니다(기능 안내 06).']},
   en:{title:'Other Questions — AI Assistant',desc:'For <b>general questions</b> not tied to a specific item, tap the <b>✦</b> button (bottom-right) on any screen to open the AI assistant.',steps:['Attach a document photo and it will be read via OCR and analyzed.','Type a question and it answers based on the audit standard.','For item-specific questions, ask from that item’s <b>🤖 AI Auto-Judge</b> instead — it is more accurate (see Feature 06).']}},
...
const PROCESS_SECTIONS=[
  ...
  {ko:{t:'② 홈 화면 구성',b:'홈에는 2개 탭이 있습니다:<ul><li><b>점검 항목</b> — 노동/윤리/공급망 정식 점검(A·AM·D·DM·E)</li><li><b>필요 서류</b> — 그룹별 요구 서류 목록</li></ul>상단 요약바에 그룹별 적합률과 총점이 실시간 표시됩니다.'},
   en:{t:'② Home Layout',b:'Home has two tabs:<ul><li><b>Audit Items</b> — formal Labor/Ethics/Supply-chain checks (A·AM·D·DM·E)</li><li><b>Documents</b> — required documents per group</li></ul>The summary bar shows per-group conformance and total score in real time.'}},
  ...
  {ko:{t:'⑤ 자동 등급 산정 규칙',b:'각 항목은 세 단계 응답 중 <b>가장 심각한 위반</b>으로 등급이 정해집니다: Conformance → Minor → Major → Priority 순으로 심각.<br><br>상단 요약바의 그룹별 적합률과 종합 점수는 답변할 때마다 자동으로 다시 계산됩니다.'},
   en:{t:'⑤ Auto-Grading Rules',b:'Each item takes the <b>most severe violation</b> among its three steps: Conformance → Minor → Major → Priority.<br><br>The per-group conformance and overall score in the summary bar are recalculated automatically as you answer.'}},
